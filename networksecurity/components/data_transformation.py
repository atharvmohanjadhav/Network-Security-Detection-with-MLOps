...
class DataTransformation:
    ...
    def get__data_transformer_object(cls)->Pipeline:
        logging.info("Entered get__data_transformer_object method in DataTransformation class")
        try:
            imputer: KNNImputer = KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info("Initialize KNNImputer!")
    ...
    def initiate_data_transformation(self)-> DataTransformationArtifact:
        ...
        try:
            ...
            preprocessor = self.get__data_transformer_object()
